...
def crossover(chromosomes: list[Chromosome]):
    ...
    while len(chromosome_copy):
        ...
        newgenes1 = [genes1[0], genes1[1], genes2[2]]
        newgenes2 = [genes2[0], genes2[1], genes1[2]]
...
for i in range(PopulationSize):
    chromosome = Chromosome(f"i{i}", [random.randint(0, 1) for i in range(3)], 0)
